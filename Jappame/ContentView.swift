...
let chars = [
    ...
    10: ["わ", "を", "ん"],
    11: ["ん"],
    12: ["が", "ぎ", "ぐ", "げ", "ご"], // G-series
    13: ["ざ", "じ", "ず", "ぜ", "ぞ"], // Z-series
    14: ["だ", "ぢ", "づ", "で", "ど"], // D-series
    15: ["ば", "び", "ぶ", "べ", "ぼ"], // B-series
    16: ["ぱ", "ぴ", "ぷ", "ぺ", "ぽ"]
]
...
struct ContentView: View {
    ...
    func getNext(){
        ...
        correctAnswer = hiraganaToRomaji[randomKey!]!
        ...
        while answers.count < 4 {
            ...
            let randomAnswer = hiraganaToRomaji[randomValue!]!
